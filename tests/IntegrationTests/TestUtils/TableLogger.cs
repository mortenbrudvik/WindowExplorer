...
namespace IntegrationTests.TestUtils
{
    ...
    public class TableLogger
    {
        ...
        public void Write(Format format = TestUtils.Format.Default)
        {
            switch (format)
            {
                case TestUtils.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case TestUtils.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case TestUtils.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case TestUtils.Format.Minimal:
