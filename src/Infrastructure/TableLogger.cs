...
namespace Infrastructure
{
    ...
    public class TableLogger
    {
        ...
        public void Write(Format format = Infrastructure.Format.Default)
        {
            switch (format)
            {
                case Infrastructure.Format.Default:
                    Options.OutputTo.WriteLine(ToString());
                    break;
                case Infrastructure.Format.MarkDown:
                    Options.OutputTo.WriteLine(ToMarkDownString());
                    break;
                case Infrastructure.Format.Alternative:
                    Options.OutputTo.WriteLine(ToStringAlternative());
                    break;
                case Infrastructure.Format.Minimal:
